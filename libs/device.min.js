...
(function () {
  var previousDevice, _addClass, _doc_element, _find, _handleOrientation, _hasClass, _orientation_event, _removeClass, _supports_orientation, _user_agent;previousDevice = window.device;window.device = {};_doc_element = window.document.documentElement;_user_agent = window.navigator.userAgent.toLowerCase();device.ios = function () {
  ...
  };_find = function _find(needle) {
    return _user_agent.indexOf(needle) !== -1;
  };_hasClass = function _hasClass(class_name) {
    var regex;regex = new RegExp(class_name, "i");return _doc_element.className.match(regex);
  };_addClass = function _addClass(class_name) {
    if (!_hasClass(class_name)) {
      return _doc_element.className += " " + class_name;
    }
  };_removeClass = function _removeClass(class_name) {
    if (_hasClass(class_name)) {
    ...
    _addClass("desktop");
  }_handleOrientation = function _handleOrientation() {
    if (device.landscape()) {
